...
# 40 CLOSE15
#
# It performs one read of drive ROM $E000. The byte is expected to be nonzero, avoiding the C64 GET# empty-string representation of a zero byte. It changes nothing in the drive.
...
$outFile = Join-Path $OutputDirectory "1541HUD_UB3_T0.0.24_ROM_Read_Proof.prg"
...
Write-Host ""
Write-Host "T0.0.24 C64 BASIC DOS-channel ROM-read proof built."
Write-Host "Run at the C64. It prints the number of bytes returned by a read of 1541 ROM $E000."
