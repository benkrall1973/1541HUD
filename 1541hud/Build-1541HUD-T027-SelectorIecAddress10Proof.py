#!/usr/bin/env python3
"""Build T0.0.27 with the Selector project's BASIC V2 tokenizer."""
...
source = root / "c64" / "1541-OneROM-IEC-Address-10-Proof-T027.bas"
output = root / "build-address-test" / "1541HUD_UB3_T0.0.27_IEC_Address_10_Proof.prg"
output.parent.mkdir(parents=True, exist_ok=True)
output.write_bytes(tokenize(source.read_text(encoding="ascii")))
print(f"Built {output}")
print("Temporary address test: writes $0077/$0078 for address 10, then reads one byte at device 10.")
