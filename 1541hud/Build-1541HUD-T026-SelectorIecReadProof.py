#!/usr/bin/env python3
"""Build T0.0.26 with the Selector project's BASIC V2 tokenizer."""
...
source = root / "c64" / "1541-OneROM-IEC-Read-Proof-T026.bas"
output = root / "build-address-test" / "1541HUD_UB3_T0.0.26_IEC_Read_Proof.prg"
output.parent.mkdir(parents=True, exist_ok=True)
output.write_bytes(tokenize(source.read_text(encoding="ascii")))
print(f"Built {output}")
print("Read-only test: M-R one byte from device 8 ROM address $E000.")
