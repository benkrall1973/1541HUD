#!/usr/bin/env python3
"""Build T0.0.28 with the Selector project's BASIC V2 tokenizer."""
...
source = root / "c64" / "1541-OneROM-Address-Switcher-T028.bas"
output = root / "build-address-test" / "1541HUD_UB3_T0.0.28_Address_Switcher_8_to_10.prg"
output.parent.mkdir(parents=True, exist_ok=True)
output.write_bytes(tokenize(source.read_text(encoding="ascii")))
print(f"Built {output}")
print("Temporary 8-to-10 switcher: writes $0077/$0078, verifies at device 10, and makes no permanent change.")
