...
# The machine-code loop sends 22 command bytes through the C64 KERNAL serial
...
$machineCode = [byte[]](
    ...
    0xBD, 0x3B, 0x08, 0x20, 0xD2, 0xFF, 0xE8, 0xE0, 0x16, 0xD0, 0xF5,
    0x20, 0xCC, 0xFF, 0xA9, 0x0F, 0x20, 0xC3, 0xFF, 0x60
)

$commandBytes = [byte[]](
    0x4D, 0x2D, 0x57, 0x00, 0x06, 0x07,
