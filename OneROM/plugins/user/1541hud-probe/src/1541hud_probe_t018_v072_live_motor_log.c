/* 1541HUD T0.0.18 OneROM v0.7.2 LIVE MOTOR LOG EXPERIMENT.
...
static const char t018_motor_on[] = "1541HUD T0.0.18 LIVE MOTOR=1\r\n";
static const char t018_motor_off[] = "1541HUD T0.0.18 LIVE MOTOR=0\r\n";
