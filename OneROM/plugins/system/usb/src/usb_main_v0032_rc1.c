...
static void drivehud_serial_task(void){
 ...
 static const char w[]="STATUS V0.0.32-RC1 WAITING\r\n";
 ...
 p=line;
 p=drivehud_append_str(p,e,"STATE V0.0.32-RC1 WPV=");p=drivehud_append_u32(p,e,m->write_protect_valid);
 ...
 p=drivehud_append_str(p,e,"HDRPHY V0.0.32-RC1 T=");
 ...
 p=drivehud_append_str(p,e,"RPM V0.0.32-RC1 T=");
 p=drivehud_append_u32(p,e,track);
 ...
 p=drivehud_append_str(p,e,"SYNC V0.0.32-RC1 COUNT=");
 ...
 p=line;
 p=drivehud_append_str(p,e,"STATUS V0.0.32-RC1 CAP=");p=drivehud_append_u32(p,e,m->capture_count);
